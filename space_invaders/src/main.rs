...
impl GameObject for Player {
	fn new() -> Player {
		Player {stats.life_points = PLAYER_MAX_LIFE,
		stats.pos = PLAYER_INITIAL_POS, 
		stats.speed = PLAYER_SPEED,
		stats.direction =  Point2::origin(),
		stats.size = PLAYER_SIZE }
	}
...
impl GameObject for Enemy {
	fn new() -> Enemy {
		Enemy {stats.life_points = ENEMY_MAX_LIFE,
		stats.pos = ENEMY_INITIAL_POS, 
		stats.speed = ENEMY_SPEED,
		stats.direction =  Point2::origin(),
		stats.size = ENEMY_SIZE }
	}
...
impl GameObject for Barrier {
	fn new() -> Barrier {
		Barrier {stats.life_points = BARRIER_MAX_LIFE,
		stats.pos = BARRIER_INITIAL_POS, 
		stats.speed = BARRIER_SPEED,
		stats.direction =  Point2::origin(),
		stats.size = BARRIER_SIZE }
	}
...
impl GameObject for Shot {
	fn new() -> Shot {
		Shot {stats.life_points = MAX_LIFE,
		stats.pos = Point2::origin(), 
		stats.speed = PLAYER_SPEED,
		stats.direction =  Point2::origin(),
		stats.size = PLAYER_SIZE }
	}
